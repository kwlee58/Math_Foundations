...
plot(x, y, ylab="y", type="l", ylim=c(-3, 8))
abline(h=0, v=0, lty=2)
```
...
y <- sqrt(abs(x))
plot(x, y, ylab="y", type="l", ylim=c(0, 8))
abline(h=0, v=0, lty=2)
```
...
x <- seq(-4, 4, length=99)
y <- -x^(3/2)
plot(x, y, ylab="y", type="l", ylim=c(-8, 0))
abline(h=0, v=0, lty=2)
```
...
y <- (-x)^(2/3)
plot(x, y, ylab="y", type="l", ylim=c(0, 4))
abline(h=0, v=0, lty=2)
```
...
x <- seq(-8, 8, length=199)
y <- -x^(2/3)
plot(x, y, ylab="y", type="l", ylim=c(-4, 0))
abline(h=0, v=0, lty=2)
```
